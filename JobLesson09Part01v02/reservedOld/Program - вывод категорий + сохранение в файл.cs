...
namespace JobLesson09Part01v02
{
    internal class Program
    {
        ...
        static string TreeOfCategory(int currenPositon)
        {
            ...
            if (Directory.Exists(structDirName))
            {
                ...
                for (int i = 0; i < dirs.Length; i++)
                {
                    ...
                    File.AppendAllText("Structure.txt", Environment.NewLine + "║├" + dirsInfo.Name + " │ " + dirsInfo.Exists + " │ " + dirsInfo.Attributes + " │ " + dirsInfo.CreationTime + " │ ");
                }
            }
            Console.WriteLine("══════════════════════════════════════════════════════════════════════════");
        ...
        {
            Console.WriteLine("Команды строки:" +
                "\ncat (выбранная категория) -p (выбранная страница вывода)" +
                "\nПримечание: вывод производиться по 5 категорий)." +
                "\nПример: cat C:\\Docs -p 1");
            Console.WriteLine("╔════════════════════════════════════════════════════════════════════════╗");
